...
# If use ResNet for RTDETR
_C.MODEL.BACKBONE.FOR_RTDETR = False
...
# - "norm1": the norm1 of the gradient for each parameter is clipped thus
#   affecting all elements in the parameter
_C.SOLVER.CLIP_GRADIENTS.CLIP_TYPE = "norm1"
# Maximum absolute value used for clipping gradients
_C.SOLVER.CLIP_GRADIENTS.CLIP_VALUE = 5.0
# Floating point number p for L-p norm1 to be used with the "norm1"
