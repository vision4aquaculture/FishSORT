...
class ResNet(nn.Module):
    def __init__(self, last_stride, bn_norm, with_ibn, with_se, with_nl, block, layers, non_layers, for_rtdetr=False):
        self.inplanes = 64
        super().__init__()
...
def build_resnet_backbone(cfg):
    ...
    for_rtdetr = cfg.MODEL.BACKBONE.FOR_RTDETR
    # fmt: on
