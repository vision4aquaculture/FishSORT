...
def make_parser():
    ...
    #添加rtdetr相关内容
    parser.add_argument("--rtdetr_reid_config", dest="rtdetr_reid_config",
                        default=r"fast_reid/configs/CUHKSYSU_DanceTrack/rtdetr_reid.yml", type=str,
                        help="reid config file path")
    parser.add_argument("--rtdetr_reid_weights", dest="rtdetr_reid_weights",
